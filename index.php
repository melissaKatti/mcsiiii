      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1><span>VOUS</span> cherchez<br> à Louer une voiturer</h1>
            <p>Louez la voiture parfaite pour votre prochaine aventure. Nous vous proposons un large choix de véhicules de qualité des voitures compactes aux SUV spacieux, pour répondre à tous vos besoins de déplacement.</p>
            <a href="#" class="btn">Réserver<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
